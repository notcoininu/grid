...
class PositionData:
    ...
    def __post_init__(self):
        ...
        if isinstance(self.unrealized_pnl, (int, float, str)):
            self.unrealized_pnl = Decimal(str(self.unrealized_pnl))
        if isinstance(self.realized_pnl, (int, float, str)):
            self.realized_pnl = Decimal(str(self.realized_pnl))
        if isinstance(self.margin, (int, float, str)):
        ...
        for field_name in timestamp_fields:
            ...
            if value is not None and isinstance(value, (int, float, str)):
                try:
                    ...
                    setattr(self, field_name, datetime.fromtimestamp(timestamp_s))
